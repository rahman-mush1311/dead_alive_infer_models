...
def per_fold_test_evaluate(fold_test_text_file, fold_test_excel_file, combined_motile_model, combined_non_motile_model, bayesian_model_without_threshold):
    ...
    test_labeled_observations=file_processor.label_observations_by_expert_labels(fold_test_excel_file,tracking_observations,labeles_loaded)
...
def prepare_train_test_setup_for_combined():
    ...
    if not os.path.isdir(user_base_dir):
        ...
        for fold_data in splits:
            ...
            fold_train_probs,fold_motile_probs,fold_non_motile_probs=combine_dictionary_non_motile_motile_probs(fold_train_probs_with_non_motile,fold_train_probs_with_non_motile)
